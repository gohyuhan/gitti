...
var eN = LanguageMapping{
	...
	AddRemotePrompt:                              "* Remote not detected, please add one.",
	RemoteNameTitle:                              "Remote Name",
	RemoteNamePlaceHolder:                        "eg, origin",
	RemoteUrlTitle:                               "Remote Url",
	RemoteUrlPlaceHolder:                         "eg, https://exp.com/exp/exp.git (https) or git@exp.com:exp/exp.git(ssh)",
	RemoteAddSuccess:                             "Successfully add remote %s: %s ",
	InvalidRemoteUrlFormat:                       "Invalid Remote Url Format",
	GitRemotePushTitle:                           "Git Push",
}
