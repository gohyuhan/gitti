...
var jA = LanguageMapping{
	...
	AddRemotePrompt:                              "* リモートが検出されません. 追加してください.",
	RemoteNameTitle:                              "リモート名",
	RemoteNamePlaceHolder:                        "例: origin",
	RemoteUrlTitle:                               "リモートURL",
	RemoteUrlPlaceHolder:                         "例: https://exp.com/exp/exp.git (https) または git@exp.com:exp/exp.git (ssh)",
	RemoteAddSuccess:                             "リモート %s: %s を正常に追加しました",
	InvalidRemoteUrlFormat:                       "無効なリモートURL形式",
	GitRemotePushTitle:                           "Gitプッシュ",
}
