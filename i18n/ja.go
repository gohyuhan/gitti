...
var jA = LanguageMapping{
	...
	CreateNewBranchBasedOnRemoteTitle:                        "リモートブランチに基づいて新しいブランチを作成する",
	CreateNewBranchBasedOnRemoteDescription:                  "リモートブランチに基づいて新しいブランチを作成します。正確なリモートブランチ名を指定する必要があります。",
