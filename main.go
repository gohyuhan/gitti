...
func main() {
	...
	default:
		...
		gittiAppModel := tui.NewGittiAppModel(tuiUpdateChannel, gitRepoPathInfo.TopLevelRepoPath, gitRepoPathInfo.RepoName, gitOperations, gittiLogging, daemonUpdateChannel, gitUpdateChannel)
